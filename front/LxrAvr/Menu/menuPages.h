...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	//page 1 - Voice 1
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_RND_MASKTYPE, TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
			PAR_COARSE1,	PAR_FINE1,	PAR_OSC_WAVE_DRUM1,	PAR_NONE,PAR_RND_VOICE1,PAR_RND_MASKTYPE1,PAR_PREFILLED_PATTERN1,PAR_RANDOMFILL_PATTERN1
		},
		//sub page 2 - Amp EG
		{
			TEXT_ATTACK,	TEXT_DECAY, TEXT_EG_SLOPE,	TEXT_SKIP,TEXT_ALIEN_DELAY,TEXT_ALIEN_FREQ,TEXT_ALIEN_STARTPHASE,TEXT_ALIEN_FB, //TEXT_PITCH_DECAY,		
			PAR_VELOA1,		PAR_VELOD1,	PAR_VOL_SLOPE1, PAR_NONE,PAR_ALIEN_DELAY,PAR_ALIEN_FREQ,PAR_ALIEN_STARTPHASE,PAR_ALIEN_FB//PAR_MOD_EG1,			
		},
	...
	//page 2 - Voice 2 - drum
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
PAR_COARSE2,	PAR_FINE2,	PAR_OSC_WAVE_DRUM2,	PAR_NONE,PAR_RND_VOICE2,PAR_RND_MASKTYPE2,PAR_PREFILLED_PATTERN2,PAR_RANDOMFILL_PATTERN2
	...
	//page 3 - Voice 3 - drum
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
			PAR_COARSE3,	PAR_FINE3,	PAR_OSC_WAVE_DRUM3,	PAR_NONE,PAR_RND_VOICE3,PAR_RND_MASKTYPE3,PAR_PREFILLED_PATTERN3,PAR_RANDOMFILL_PATTERN3
			//TEXT_COARSE,	TEXT_FINE,	TEXT_DRIVE,	TEXT_WAVEFORM,	
	...
	//page 4 - Voice 4 - snare/clap
	{
		//sub page 1
		{
			TEXT_COARSE,TEXT_FINE,TEXT_NOISE,TEXT_MIX,TEXT_WAVEFORM,TEXT_EMPTY,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
			PAR_COARSE4,	PAR_FINE4,	PAR_NOISE_FREQ1,	PAR_MIX1,	PAR_OSC_WAVE_SNARE,	PAR_NONE,PAR_PREFILLED_PATTERN4,PAR_RANDOMFILL_PATTERN4	
		},
		//sub page 2
		{
		...
		//sub page 4 - FM
		{
			TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_RND_VOICE4,PAR_RND_MASKTYPE4,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},
		//smp
		{
			TEXT_TRANSIENT_WAVE,	TEXT_TRANSIENT_VOLUME,	TEXT_TRANSIENT_FREQ, 	TEXT_EMPTY,	TEXT_EMPTY,	TEXT_EMPTY,	TEXT_EMPTY, TEXT_EMPTY,	
	...
	//page 5 - Voice 5 - cymbal
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE, TEXT_WAVEFORM,TEXT_SKIP,TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
			PAR_COARSE5,	PAR_FINE5, 	PAR_WAVE1_CYM,	PAR_NONE,PAR_RND_VOICE5,PAR_RND_MASKTYPE5,PAR_PREFILLED_PATTERN5,PAR_RANDOMFILL_PATTERN5		
		},
		//sub page 2
		{
			TEXT_ATTACK,	TEXT_DECAY,	TEXT_REPEAT,	TEXT_EG_SLOPE,		TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
	...
	//page 6 - Voice 6 - HH (FM)
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,TEXT_WAVEFORM,TEXT_SKIP,TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,	
			PAR_COARSE6,	PAR_FINE6,PAR_WAVE1_HH,	PAR_NONE,PAR_RND_VOICE6,PAR_RND_MASKTYPE6,PAR_PREFILLED_PATTERN6,PAR_RANDOMFILL_PATTERN6			
		},
		//sub page 2 - amp eg
		{
	...
	//page 7 - Voice 6 - HH/Cymbal (FM) - same as voice 6 -> open hi hat
	{
		//sub page 1 - osc
		{
			TEXT_COARSE,	TEXT_FINE,TEXT_WAVEFORM,TEXT_SKIP,TEXT_SKIP,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,		
	...
	{
		{		
		TEXT_SHUFFLE,	TEXT_ROLL_SPEED,	TEXT_X_FADE,	TEXT_SAMPLE_RATE,			 TEXT_FX1,	TEXT_FX1_AMOUNT,	TEXT_FX2,	TEXT_FX2_AMOUNT,
		PAR_SHUFFLE,	PAR_ROLL,			PAR_MORPH,		PAR_VOICE_DECIMATION_ALL,		PAR_FX1,	PAR_FX1_AMOUNT,	PAR_FX2,	PAR_FX2_AMOUNT
		
		
		},{
			TEXT_ALIEN_DELAY,TEXT_ALIEN_FREQ,TEXT_ALIEN_STARTPHASE,TEXT_ALIEN_FB,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_ALIEN_DELAY,PAR_ALIEN_FREQ,PAR_ALIEN_STARTPHASE,PAR_ALIEN_FB,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
			TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
			PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE,PAR_NONE
		},{
