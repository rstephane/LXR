...
const Page menuPages[NUM_PAGES][NUM_SUB_PAGES] PROGMEM =
{
	//page 1 - Voice 1
	{
		//sub page 1 - Oscillator
		{
			...
			PAR_COARSE1,	PAR_FINE1,	PAR_OSC_WAVE_DRUM1,	PAR_NONE,PAR_RND_VOICE1,PAR_RND_MASKTYPE1,PAR_PREFILLED_PATTERN0,PAR_RANDOMFILL_PATTERN0
		},
		//sub page 2 - Amp EG
		{
	...
	//page 2 - Voice 2 - drum
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
PAR_COARSE2,	PAR_FINE2,	PAR_OSC_WAVE_DRUM2,	PAR_NONE,PAR_RND_VOICE2,PAR_RND_MASKTYPE2,PAR_PREFILLED_PATTERN1,PAR_RANDOMFILL_PATTERN1
	...
	//page 3 - Voice 3 - drum
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,	TEXT_WAVEFORM,	TEXT_SKIP, TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
			PAR_COARSE3,	PAR_FINE3,	PAR_OSC_WAVE_DRUM3,	PAR_NONE,PAR_RND_VOICE3,PAR_RND_MASKTYPE3,PAR_PREFILLED_PATTERN2,PAR_RANDOMFILL_PATTERN2
			//TEXT_COARSE,	TEXT_FINE,	TEXT_DRIVE,	TEXT_WAVEFORM,	
	...
	//page 4 - Voice 4 - snare/clap
	{
		//sub page 1
		{
			...
			PAR_COARSE4,	PAR_FINE4,	PAR_NOISE_FREQ1,	PAR_MIX1,	PAR_OSC_WAVE_SNARE,	PAR_NONE,PAR_PREFILLED_PATTERN3,PAR_RANDOMFILL_PATTERN3	
		},
		//sub page 2
		{
	...
	//page 5 - Voice 5 - cymbal
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE, TEXT_WAVEFORM,TEXT_SKIP,TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,
			PAR_COARSE5,	PAR_FINE5, 	PAR_WAVE1_CYM,	PAR_NONE,PAR_RND_VOICE5,PAR_RND_MASKTYPE5,PAR_PREFILLED_PATTERN4,PAR_RANDOMFILL_PATTERN4		
		},
		//sub page 2
		{
			TEXT_ATTACK,	TEXT_DECAY,	TEXT_REPEAT,	TEXT_EG_SLOPE,		TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
	...
	//page 6 - Voice 6 - HH (FM)
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,TEXT_WAVEFORM,TEXT_SKIP,TEXT_RND_VOICE,TEXT_RND_MASKTYPE,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,	
			PAR_COARSE6,	PAR_FINE6,PAR_WAVE1_HH,	PAR_NONE,PAR_RND_VOICE6,PAR_RND_MASKTYPE6,PAR_PREFILLED_PATTERN5,PAR_RANDOMFILL_PATTERN5			
		},
		//sub page 2 - amp eg
		{
	...
	{
		{		
		TEXT_SHUFFLE,	TEXT_ROLL_SPEED,	TEXT_X_FADE,	TEXT_SAMPLE_RATE,			 TEXT_DIVIDE,	TEXT_LOOP,	TEXT_OTO,	TEXT_OTO_AMOUNT,
		PAR_SHUFFLE,	PAR_ROLL,			PAR_MORPH,		PAR_VOICE_DECIMATION_ALL,		PAR_DIVIDE,	PAR_LOOP,	PAR_OTO,	PAR_OTO_AMOUNT
