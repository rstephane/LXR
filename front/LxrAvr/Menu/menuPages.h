...
PAR_COARSE2,	PAR_FINE2,	PAR_OSC_WAVE_DRUM2,	PAR_NONE,PAR_RND_VOICE2,PAR_RND_MASKTYPE2,PAR_PREFILLED_PATTERN1,PAR_RANDOMFILL_PATTERN1
	...
	//page 5 - Voice 5 - cymbal
	{
		//sub page 1
		{
			TEXT_COARSE,	TEXT_FINE, TEXT_WAVEFORM,TEXT_SKIP,TEXT_SKIP	,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,TEXT_EMPTY,
			PAR_COARSE5,	PAR_FINE5, 	PAR_WAVE1_CYM,	PAR_NONE,PAR_NONE,PAR_PREFILLED_PATTERN4,PAR_RANDOMFILL_PATTERN4,PAR_NONE		
		},
		//sub page 2
		{
			TEXT_ATTACK,	TEXT_DECAY,	TEXT_REPEAT,	TEXT_EG_SLOPE,		TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
	...
	//page 6 - Voice 6 - HH (FM)
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,TEXT_WAVEFORM,TEXT_SKIP,TEXT_SKIP,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,TEXT_EMPTY,	
			PAR_COARSE6,	PAR_FINE6,PAR_WAVE1_HH,	PAR_NONE,PAR_NONE,PAR_PREFILLED_PATTERN5,PAR_RANDOMFILL_PATTERN5,PAR_NONE			
		},
		//sub page 2 - amp eg
		{
	...
	//page 7 - Voice 6 - HH/Cymbal (FM) - same as voice 6 -> open hi hat
	{
		...
		{
			TEXT_COARSE,	TEXT_FINE,TEXT_WAVEFORM,TEXT_SKIP,TEXT_SKIP,TEXT_PREFILLED_PATTERN,TEXT_RANDOMFILL_PATTERN,TEXT_EMPTY,		
			PAR_COARSE6,	PAR_FINE6,PAR_WAVE1_HH,	PAR_NONE,PAR_NONE,PAR_PREFILLED_PATTERN6,PAR_RANDOMFILL_PATTERN6,PAR_NONE			
		},
		//sub page 2 - amp eg
		{
			TEXT_ATTACK,	/*TEXT_DECAY_CLOSED,*/	TEXT_DECAY_OPEN,	TEXT_EG_SLOPE, 	TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,TEXT_EMPTY,
