...
const Name valueNames[NUM_NAMES] PROGMEM =
{
		...
		{SHORT_ALIEN_FREQ,CAT_EMPTY,LONG_ALIEN_FREQ},
		{SHORT_ALIEN_STARTPHASE,CAT_EMPTY,LONG_ALIEN_STARTPHASE},
		{SHORT_ALIEN_FB,CAT_EMPTY,LONG_ALIEN_FB},	
...
// ------------------------------------------------------------------------------------------
	...
	/*PAR_RND_MASKTYPE4,*/		DTYPE_1B16,  
	/*PAR_RND_MASKTYPE5,*/		DTYPE_1B16,  
